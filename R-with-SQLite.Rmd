...
# append = TRUE preserves what's in the table if it existed
...
By the way, once you've opened your database, you can perform any SQL queries you want in R notebook SQL chunk, just add the name of connection in the header of the chunk.
